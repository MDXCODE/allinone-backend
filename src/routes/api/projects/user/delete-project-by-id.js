...
module.exports = async (req, res) => {
    ...
    client.query(`DELETE FROM "allinone-userschema"."projects" WHERE project_id = $1;`, [id], (err, result) => {
        if (err) {
            ...
            res.status(404).json(createErrorResponse(404, `Project with ID '${id}' doesn't exist`));
        } else {
